...
class AiCoachNotifier extends _$AiCoachNotifier {
  ...
  List<ChatMessage> build() {
    ...
    if (apiKey == null || apiKey.isEmpty) {
      return [ChatMessage(text: "API Key missing! Please set GEMINI_API_KEY in .env.", isUser: false)];
    }
    ...
    return [
      ChatMessage(
        text: "Hi! I'm your Flo AI Coach. Ask me how to optimize your spending or analyze your recent trends!",
        isUser: false,
      )
    ];
  }
...
""";
      ...
      state = [...state, ChatMessage(text: response.text ?? "I'm having trouble thinking right now.", isUser: false)];
    } catch (e) {
      state = [...state, ChatMessage(text: "Error communicating with AI: $e", isUser: false)];
    }
  }
}
